...
namespace ProductCatalogAPI.Controllers
{
	...
	public class SupermarketController : ControllerBase
	{
        ...
        public SupermarketController(SupermarketContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        //public StaffModel[] getProductById(int id)
        //{
        //    IQueryable<Staff> query = _context.Staff.Include(c => c.Role).Include(a=>a.Address).Where(t => t.staffId == id);
        //    var result = query.ToArray();
        //    return _mapper.Map<StaffModel[]>(result);
        //}

        ////getting staff data using query string
        //[HttpGet("staff/{id}")]
        [HttpGet("staff-members/{id}")]
